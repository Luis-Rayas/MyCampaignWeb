        ...
        <form action="{{ route('campaign.update') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-header">
                <div class="mb-3">
                    ...
                    <input type="text" class="@error('nombre') is-invalid @enderror form-control" id="nombre" required value="{{ old('nombre', $campaign->name) }}" name="nombre" />
                </div>
                <div class="mb-3">
            ...
            <div class="card-body">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="partido" required value="{{ old('partido', $campaign->party) }}" name="partido" />
                </div>
                <div class="mb-3">
                    <div class="row">
                        <div class="col-6">
                            ...
                            <input type="date" class="@error('inicio_campania') is-invalid @enderror form-control" id="inicio_campania" required
                                value="{{ old('inicio_campania', $campaign->start_date) }}" name="inicio_campania" />
                        </div>
                        <div class="col-6">
                            <label for="fin_campania" class="@error('fin_campania') is-invalid @enderror inicio_campania">Fin de Campaña*</label>
                            <input type="date" class="form-control" id="fin_campania" required value="{{ old('fin_campania', $campaign->end_date) }}"
                                name="fin_campania" />
                        </div>
                    </div>
                </div>
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="descripcion" rows="3" value="{{ old('descripcion', $campaign->description) }}" name="descripcion"></textarea>
                </div>
